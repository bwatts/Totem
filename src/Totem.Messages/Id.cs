...
namespace Totem
{
    ...
    public sealed class Id : IEquatable<Id>, IComparable<Id>
    {
        ...
        public int CompareTo(Id? other) => other == null ? 1 : _value.CompareTo(other._value);
        ...
        public static bool TryFrom(Guid? value, [NotNullWhen(true)] out Id? id) =>
          (id = value != null && value != Guid.Empty ? new Id(value.Value) : null) != null;

        public static bool TryFrom(string? value, [NotNullWhen(true)] out Id? id) =>
          (id = Guid.TryParse(value, out var guid) && guid != Guid.Empty ? new Id(guid) : null) != null;

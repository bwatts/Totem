        ...
        where TEvent : class, IEvent
    {
        public EventContext(Id pipelineId, IEventEnvelope envelope) : base(pipelineId, envelope)
        {
            ...
            if(envelope.Message is not TEvent e)
                throw new ArgumentException($"Expected event type {typeof(TEvent)} but received {envelope.MessageType}", nameof(envelope));
        ...
        public Type EventType => Envelope.MessageType;

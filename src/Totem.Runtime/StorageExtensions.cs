...
public static class StorageExtensions
{
    ...
    public static async Task<T?> GetValueAsync<T>(this IStorage storage, StorageKey key, CancellationToken cancellationToken)
    {
        ...
        return row is null ? default : row.Value;
    }
    ...
    public static Task PutAsync<T>(this IStorage storage, IEnumerable<string> partitionKeys, T value, CancellationToken cancellationToken)
    {
        if(storage is null)
            throw new ArgumentNullException(nameof(storage));
    ...
    public static Task PutAsync<T>(this IStorage storage, IEnumerable<string> partitionKeys, string rowKey, T value, DateTimeOffset? whenExpires, CancellationToken cancellationToken)
    {
        if(storage is null)
            throw new ArgumentNullException(nameof(storage));
